...
buildscr = 70
downlurl := "https://github.com/1opaSgorela/admtools/raw/main/nupdt.exe?raw=true"
...
checkboxState := 0
Gui, Font, cWhite
Gui, Add, Tab, x2 y-1 w1360 h540 , Загальні налаштування |Налаштування команд |Налаштування репортів 01 |Налаштування репортів 02 |Дати пізди :3
...
Gui, Add, Button, x235 y260 w200 h30 gToggleMusic vToggleMusicButton, Гімн тестерів
...
FileInstall, C:\Users\Василь\Desktop\tools, %TempImagePath1%
Gui, Add, Picture, x950 y500 w130 h50, %TempImagePath1%
musicEnabled := false
Gui, Add, Text, x12 y549 w1110 h25 , Admin Tools by Pichkur v %Version%. З любов'ю для адміністрації UKRAINE GTA ♡
...
Gui, Add, Text, x480 y220 w650 h20 , ALT+R - дана комбінація одразу зайнята вкладкою "Дати пізди"
...
Gui, Add, Text, x480 y260 w650 h20 , В разі багів\поліпшень, прошу писати в TG: @Evgeniy_Pichkur/@tonihoffman
Gui, Font, S7
...
Gui, Tab, Налаштування команд
Gui, Add, Text, x12 y549 w1130 h25 , Admin Tools by Pichkur v %Version%. З любов'ю для адміністрації UKRAINE GTA ♡
Gui, Font, cBlack
...
Gui, Add, Text, x12 y549 w1140 h25 , Admin Tools by Pichkur v %Version%. З любов'ю для адміністрації UKRAINE GTA ♡
CustomColor3 = 6A9AB6
Gui +LastFound
Gui, Color, 000000
WinSet, TransColor, %CustomColor3% 470
Gui, Show, x127 y87 h594 w1165 , Admin Tools by Pichkur v %Version%
